...
const content = {
  sr: {
    ...
    branch: "Ogranak 1",
    technicalPreparation: "Tehnička priprema",
  ...
  en: {
    ...
    branch: "Branch 1",
    technicalPreparation: "Technical preparation",
    ...
    <main className="contact-new-page">
      <section className="contact-new-hero">
        ...
        <div className="contact-new-hero-content">
          <span className="contact-new-label">{t.label}</span>
          <h1>{t.title}</h1>
          <p>{t.intro}</p>
        </div>
      </section>
      ...
      <section className="contact-new-main">
        <div className="contact-new-info-panel">
          <span className="contact-new-label contact-new-label-light">
            {t.contactLabel}
          </span>

          <article className="contact-new-office-card">
            <div className="contact-new-office-number">01</div>

            <div className="contact-new-office-content">
              <h2>{t.headquarters}</h2>

              <a
                href="https://www.google.com/maps/search/Novi+Sad,+Bulevar+Slobodana+Jovanovi%C4%87a+128+i"
                target="_blank"
                rel="noopener noreferrer"
                className="contact-new-address"
              >
                Novi Sad, Bulevar Slobodana Jovanovića 128i
              </a>
            </div>
          </article>

          <article className="contact-new-office-card">
            <div className="contact-new-office-number">02</div>

            <div className="contact-new-office-content">
              <h2>{t.branch}</h2>

              <a
                href="https://www.google.com/maps/search/Dr+Ivana+Ribara+128"
                target="_blank"
                rel="noopener noreferrer"
                className="contact-new-address"
              >
              ...
              <div className="contact-new-technical">
                <span>{t.technicalPreparation}</span>
                <a href="tel:+38169685777">069 685 777</a>
              </div>

              <a href="mailto:office@mpms.rs" className="contact-new-email">
                office@mpms.rs
              </a>
            </div>
          </article>
        ...
        >
          ...
          <div className="contact-new-form-row">
            <div className="contact-new-form-group">
              ...
              />
              {errors.name && (
                <span className="contact-new-error">{t.errors[errors.name]}</span>
              )}
            </div>
            ...
            <div className="contact-new-form-group">
              ...
              />
              {errors.email && (
                <span className="contact-new-error">{t.errors[errors.email]}</span>
              )}
            </div>
          </div>
          ...
          <div className="contact-new-form-row">
            <div className="contact-new-form-group">
              ...
              />
              {errors.phone && (
                <span className="contact-new-error">{t.errors[errors.phone]}</span>
              )}
            </div>
            ...
            <div className="contact-new-form-group">
              ...
              />
              {errors.subject && (
                <span className="contact-new-error">{t.errors[errors.subject]}</span>
              )}
            </div>
          </div>
          ...
          <div className="contact-new-form-group">
            ...
            />
            {errors.message && (
              <span className="contact-new-error">{t.errors[errors.message]}</span>
            )}
          </div>
          ...
          {submitStatus === "success" && (
            <p className="contact-new-success" role="status">
              {t.success}
            </p>
          )}
        </form>
      ...
      <section className="contact-new-location">
        <div className="contact-new-location-heading">
          <span className="contact-new-label">{t.locationLabel}</span>
        </div>

        <div className="contact-new-map-wrapper">
          <div className="contact-new-map-card">
            <div className="contact-new-map-title">Dr. Ivana Ribara 128</div>

            <iframe
              title="Dr. Ivana Ribara 128"
